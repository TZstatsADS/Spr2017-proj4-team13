...
start.time <- Sys.time()
result_sclust =  Spectral.Cluster(t(as.matrix(dtm_train_tfidf)),n.cluster =length(unique(AKumar$AuthorID)))
result_sclust1 <- specc(as.matrix(dtm_train_tfidf), 
