...
source("../lib/paper3/Create_Matrix.R")
source("../lib/paper3/TFIDF.R")
...
SLee.journal = Create_Journal(SLeel)
...
```{r}
#We evaluate our clustering results by using our own ways, and details can be seen in the Misclassification.R
#Misclassification(filename,classify)

#The results can be senn in the following diagram:
