...
```{r}
list.of.packages = c("expm","pacman")
...
pacman::p_load(text2vec, dplyr, qlcMatrix, kernlab, knitr)
 ...
 setwd("D:/Columbia University/Spring2017-Applied Data Science/Project_4_Bz2290/Spr2017-proj4-team13/lib")# here replace it with your own path or manually set it in RStudio to where this rmd file is located
...
source("../lib/Spectral ClusterQR.R")
start.time <- Sys.time()
result_sclust <- Spectral.Cluster(as.matrix(dtm_train_tfidf), n.cluster=2)
